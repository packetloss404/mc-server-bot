...
export class SkillLibrary {
  ...
  private saveIndex(): void {
    ...
    // the active index. Then route through atomicWriteJsonSync (write-to-tmp
    // + rename) so a crash mid-save can't truncate the index.
    ...
    atomicWriteJsonSync(this.indexPath, merged);
  }
